...
const GetTransactions = () => {
  ...
  // Fetch Records (Income or Expenses)
  const fetchRecords = async () => {
    try {
      
      // Fetch either income or expenses depending on the recordType
      ...
      if (res.data.success) {
        ...
        toast.error(`Error fetching : ${res.data.message}`);
      }
    } catch (error) {
  ...
  // Calculate total amount (subtract for expenses)
  ...
  // Fetch records when `recordType` changes
  useEffect(() => {
